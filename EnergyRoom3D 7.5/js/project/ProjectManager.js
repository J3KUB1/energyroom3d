...
function defaultHouseState(){
  ...
  const rooms = [room('kitchen','kitchen'), room('living','living'), room('main','room'), room('office','office'), room('garage','garage')];
  rooms.find(r=>r.id==='main').name = I18n.t('roomtype.bedroom');
  const positions = { kitchen:[0,0], living:[5,0], main:[0,4], office:[7,5.5], garage:[12.9,0] };
