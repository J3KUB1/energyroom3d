...
class SimulationEngine {
  ...
  serializeProgress(){
    return {
      ...
      maxObservedPowerW:this.maxObservedPowerW,overloadMinutes:this.overloadMinutes,gridOfflineMinutes:this.gridOfflineMinutes,currentOutageMinutes:this.currentOutageMinutes,longestOutageMinutes:this.longestOutageMinutes,roomTemperatures:this.roomTemperatures,comfortPct:this.comfortPct,
  ...
  deserializeProgress(data){
    ...
    this.maxObservedPowerW=data.maxObservedPowerW||0;this.overloadMinutes=data.overloadMinutes||0;this.gridOfflineMinutes=data.gridOfflineMinutes||0;this.currentOutageMinutes=data.currentOutageMinutes||0;this.longestOutageMinutes=data.longestOutageMinutes||0;this.roomTemperatures=data.roomTemperatures||{};this.comfortPct=data.comfortPct??100;
  ...
  resetProgress(){
    ...
    this.totalBatteryChargeKWh=0;this.totalBatteryDischargeKWh=0;
    this.totalEvCostZl=0;this.electricalTripCount=0;this._startAbsMin=this.absMin;this.maxObservedPowerW=0;this.overloadMinutes=0;this.gridOfflineMinutes=0;this.currentOutageMinutes=0;this.longestOutageMinutes=0;this.roomTemperatures={};this.comfortPct=100;
