...
function createContext(extraFiles){
  ...
  const files = [
    'js/data/devices.js','js/data/furniture.js','js/data/solar.js','js/data/battery.js','js/data/electrical.js',
    ...
    'js/energy/ElectricalSystem.js','js/energy/SimulationEngine.js','js/automation/AutomationManager.js',
