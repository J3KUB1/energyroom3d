...
FURNITURE_DEFINITIONS.push(
  { id:'car',         name:'Samochód',        modelType:'car',         footprint:[1.9,4.3] },
  { id:'workbench',   name:'Stół warsztatowy',modelType:'workbench',   footprint:[1.6,0.6] },
  { id:'garageshelf', name:'Regał warsztatowy',modelType:'garageshelf',footprint:[1.1,0.4] },
);
